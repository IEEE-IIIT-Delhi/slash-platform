...
export const ERR_NO_PLAYER = 'Team with requested ID not found'
...
export const ERR_INVALID_CREDS = 'Wrong team name or password'
export const ERR_INVALID_EMAIL_USERNAME = 'Invalid team name'
